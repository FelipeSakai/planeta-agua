CREATE TYPE "public"."payment_method" AS ENUM('CASH', 'PIX', 'CREDIT_CARD', 'DEBIT_CARD', 'OTHER');--> statement-breakpoint
CREATE TYPE "public"."sale_status" AS ENUM('COMPLETED', 'CANCELED');--> statement-breakpoint
CREATE TYPE "public"."stock_movement_type" AS ENUM('IN', 'OUT', 'ADJUSTMENT', 'SALE', 'CANCELED_SALE');--> statement-breakpoint
